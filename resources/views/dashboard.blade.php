            ...
            <div class="iconCategoryWrapper ">
                ...
                <a href="/b/local/business" data-testid="category-card" data-heap-id="homepage-category-tiles">
                    <div class="iconCategoryCard">
                        ...
                        <p class="iconCategoryCardTitle eds-text-weight--heavy">Affaires</p>\
                    </div>
                </a>
                <a href="/b/local/food-and-drink" data-testid="category-card" data-heap-id="homepage-category-tiles">
                    <div class="iconCategoryCard">
                        <div class="iconCategoryCardImageWrapper">
        ...
        <div class="home-category_tiles_block_component__tiles">
            ...
            <div class="home-category_tile_component__root">
                <div class="home-category_tile_component__tileDetail">
                  ...
                  <p class="home-category_tile_component__tileSubtitle">Openers, Logo Stings and more</p>
                ...
                <a class="home-category_tile_component__tileArt" title="View After Effects" href="{{route('showDetails', $event->id)}}">
                  <div class="home-category_tile_component__imageIconWrapper">
                    <picture class="home-category_tile_component__imageWrapper" style="max-height: 310px">
                      <img src="{{asset(''. $event->image)}}">
                    </picture>
                    <div class="home-category_tile_component__tileIcon">
                      <img alt="After Effects" width="64" height="64" loading="lazy" src="https://assets.market-storefront.envato-static.com/storefront/assets/category-icons/videohive/after-effects-project-files-c853be43fc510066f603fbb68e68f4504e40b2542338c6c24b6c3e19d90e2081.svg">
                    </div>
                  </div>
                </a>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    @foreach($events as $event)
                        ...
                        @endif
                        <form action="{{route('showDetails', $event->id)}}" method="GET">
                            @csrf
