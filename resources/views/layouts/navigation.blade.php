    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('listReservationsDomand')" :active="request()->routeIs('listReservationsDomand')">
                        {{ __('tickets list') }}
                    </x-nav-link>
                </div>
                @endrole
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('addCategoryForm')" :active="request()->routeIs('addCategoryForm')">
                        {{ __('new category') }}
                    </x-nav-link>
                </div>
                @endrole
