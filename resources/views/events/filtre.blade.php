    ...
    <div class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
        <div class="pt-24">
            <div class=" text-center container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
              ...
              <div class=" ml-20 text-yellow-50 text-4xl">Get events by category</div>
              @endforeach
            </div>
          </div>
                ...
                <a class="home-category_tile_component__tileArt" title="View After Effects" href="{{route('showDetails', $event->id)}}">
                  <div class="home-category_tile_component__imageIconWrapper">
                    ...
                    <div class="home-category_tile_component__tileIcon">
                      <img class="w-[64px] h-[64px] rounded-full shadow-2xl object-cover" alt="Avatar" width="64" height="64" loading="lazy" src="{{asset(''. $event->organisateurs->avatar)}}">
                    </div>
                  </div>
                </a>
            </div>
