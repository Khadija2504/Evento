    ...
    <div class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
        <div class="pt-24">
            <div class=" text-center container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
              ...
              <div class=" ml-20 text-yellow-50 text-4xl">My events</div>
            </div>
          </div>
        ...
        @endif
    <div class="home-category_tiles_block_component__wrapper mt-20 mb-20">
                  ...
                  @role('organisateur')
                        ...
                        @if($id_organisateur == $event->id_organisateur)
                            <form action="{{route('deleteEvent', $event->id)}}" method="post">
                                @csrf
                                @method('delete')
                                <button class="home-category_tile_component__tileLink" type="submit">delete</button>
                            </form>
                        @endif
                    @endrole
                </div>
